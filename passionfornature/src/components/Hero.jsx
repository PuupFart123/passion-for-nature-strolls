        ...
        <div className="container">
          <div className="hero-text">
            ...
            <div className="hero-cta fade-in-up">
              <a href="https://www.signupgenius.com/go/10C0A4FA4AF2AA5F4CE9-64575969-july" target="_blank" rel="noopener noreferrer" className="btn btn-primary" style={{ textDecoration: 'none', display: 'inline-block' }}>
                Join Our Next Stroll
              </a>
              <a href="/Sammamish%20Walks%20(2).pdf" target="_blank" rel="noopener noreferrer" className="btn btn-secondary" style={{ textDecoration: 'none', display: 'inline-block' }}>
                Learn More
              </a>
            </div>
          </div>
