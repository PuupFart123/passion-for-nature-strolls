          ...
          <div className="grid grid-2">
            <div className="event-info">
              ...
              <div className="hero-cta event-cta">
                ...
                <a href="/2025-10%20PFN%20PR%20Flyer%20for%20Enews.pdf" target="_blank" rel="noopener noreferrer" className="btn btn-secondary" style={{ display: 'inline-block', textDecoration: 'none' }}>View Details</a>
              </div>
            </div>
